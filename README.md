...
| USER STORY: About Page | [#14](https://github.com/Dekeypetey40/TTRPG-Hub/issues/14) | As a user, I can read what the blog is all about, so that I can understand the blog's purpose. | [] | Could Have |
